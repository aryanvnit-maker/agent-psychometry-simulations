...
I tested this against sequential chain topology across 118 deterministic simulations, four scenario types, and two model families (Gemini 2.5 Flash and Claude 3.5 Sonnet).

Chain topology wins by 17–22 points on task scores (graded 0–100 against final deliverables only, not transcripts, to eliminate formatting bias). Adding agents past N=2 on a chain hurts performance monotonically. A sequential chain of 2 agents mathematically outperforms a flat swarm of 8.
