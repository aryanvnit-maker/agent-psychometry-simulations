...
_ROLE_INSTRUCTIONS: dict[Role, str] = {
    ...
    Role.ALGORITHMIST: (
        ...
        "approach including data structures and complexity, and enumerate all edge cases. "
        "Do not write runnable code. Produce a complete specification that an implementer "
        "can translate directly into Python without ambiguity."
    ),
}
